...
export const addPostAPI = async (data) => {
  ...
  try {
    const res = await fetch(url + `posts`, options);
    return res.json()
  }
  catch (err) {
    console.error(err)
...
export const removePostAPI = async (postId) => {
  ...
  try {
    const res = await fetch(url + `posts/${postId}`, options);
    return res.json()
  }
  catch (err) {
    console.error(err)
...
export const editPostAPI = async (data) => {
  ...
  try {
    const res = await fetch(url + `posts/${id}`, options);
    return res.json()
  }
  catch (err) {
    console.error(err)
...
export const fetchComments = async (postId) => {
  const options = { method: 'get', headers: getAuthHeaders() };
  try {
    const res = await fetch(url + `posts/${postId}/comments`, options)
    return res.json()
  } catch (err) {
    console.err(err)
  }
...
export const increaseCommentScoreAPI = async (commentId) => {
  ...
  try {
    const res = await fetch(url + `comments/${commentId}`, options);
    return res.json()
  }
  catch (err) {
    console.error(err)
...
export const addCommentAPI = async (data) => {
  ...
  try {
    const res = await fetch(url + `comments`, options);
    return res.json()
  }
  catch (err) {
    console.error(err)
...
export const editCommentAPI = async (data) => {
  ...
  try {
    const res = await fetch(url + `comments/${id}`, options);
    return res.json()
  }
  catch (err) {
    console.error(err)
